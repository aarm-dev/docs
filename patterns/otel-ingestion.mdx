...
<Note>
This is an <strong>observational</strong> pattern. It enables detection and alerting but not inline enforcement. For blocking capabilities, combine with the <a href="/patterns/mcp-gateway">MCP Gateway</a> or SDK architecture.
</Note>
