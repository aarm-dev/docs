...
<Steps>
  <Step title="Refer to your solution as an AARM system">
    If your system is conformant, you agree to describe it publicly as an AARM system. You can give your product any commercial name you like. For example: "Acme Inc. built AIInspector, an AARM system." AARM is a specification, not a product, and the naming convention should reflect that.
  </Step>
  <Step title="Publish a dedicated conformance page">
    Maintain a publicly accessible page explaining how your system satisfies each conformance requirement (R1 through R6 for Core, R1 through R9 for Extended). This page should map specific capabilities to specific requirements and note any limitations or areas of partial coverage.
  </Step>
